...
import 'package:game/tiles.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Swiper(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(cornerRadius), color: darkBrown),
                child: Stack(
                  children: stackItems,
                ),
              ),
            ...
            BigButton(
                label: "Undo", color: numColor, onPressed: gameStates.isEmpty ? null : undoMove),
